...
const login = async (email, password)=>{
    try {
        ...
        (0, _alerts.showAlert)("error", "login or password did not match! Try again");
    }
};
const signup = async (name, email, password, passwordConfirm)=>{
    try {
        ...
        if (res.data.status === "success") (0, _alerts.showAlert)("success", "Signed up successfully");
        window.setTimeout(()=>{
            location.assign("/");
        }, 1500);
    } catch (err) {
        (0, _alerts.showAlert)("error", "Please fill the fields correctly");
    }
};
const logout = async ()=>{
    try {
...
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const stripe = Stripe("pk_test_51NMt3dD1RDCIX8YPcCiP9QzLJsQFhgNLTB0W0Ux95f37VDMy9q7bz3MDqPnD3hVEoMYhEAGgebR18vlhwZHjvOxE004N1DeIWW");
...
},{"./alerts":"6Mcnf","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["f2QDv"], "f2QDv", "parcelRequire11c7")
